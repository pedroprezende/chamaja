...
const styles = StyleSheet.create({
  ...
  filterRow: {
    flexDirection: "row", paddingHorizontal: 16, gap: 8, marginTop: 10, marginBottom: 4,
  },
  filterBtn: {
  ...
  provCard: {
    backgroundColor: "#FFFFFF", borderRadius: 14, borderWidth: 1, borderColor: "#F3F4F6",
    overflow: "hidden",
  },
  provMain: { flexDirection: "row", alignItems: "center", padding: 12, gap: 12 },
  avatar: { width: 50, height: 50, borderRadius: 25, backgroundColor: "#F3F4F6" },
  provNameRow: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 3 },
  provName: { fontSize: 14, fontWeight: "700", color: "#111827", maxWidth: 130 },
  statusBadge: { backgroundColor: "#DCFCE7", borderRadius: 5, paddingHorizontal: 6, paddingVertical: 1 },
  ...
  menuBtn: {
    width: 34, height: 34, borderRadius: 17, backgroundColor: "#F9FAFB",
    alignItems: "center", justifyContent: "center",
  },
});

...
const SEED_PROVIDERS = [
  {
    ...
    description:
      "Profissional especializado em elétrica residencial e predial. Instalações, reparos, padrão de entrada, chuveiro, tomadas, iluminação e curtos-circuitos. Atendimento emergencial 24h.",
    rating: 4.9,
    ratingCount: 128,
    // Coordenadas Centro
    latitude: -22.952,
  ...
  },
  {
    ...
    description:
      "Encanador profissional para caça-vazamento, reparo de vazamentos em canos de PVC e cobre, limpeza de caixa de água, manutenção de torneiras, vasos sanitários e válvulas hydra.",
    rating: 4.8,
    ratingCount: 96,
  ...
  },
  {
    ...
    description:
      "Serviços de limpeza residencial e comercial de alta qualidade. Faxina padrão, faxina pesada, pré/pós mudança, passar roupa e organização de closets. Confiança e capricho garantidos.",
    rating: 4.9,
    ratingCount: 74,
  ...
  },
  {
    ...
    description:
      "Montagem e desmontagem de móveis, fixação de suportes de TV, cortinas, prateleiras, varais. Troca de lâmpadas, reatores e pequenos reparos elétricos e hidráulicos em geral.",
    rating: 4.7,
    ratingCount: 53,
  ...
  },
  {
    ...
    description:
      "Pintor experiente para residências, apartamentos e prédios comerciais. Aplicação de massa corrida, massa acrílica, texturas, grafiato e verniz. Tintas premium para acabamento excelente.",
    rating: 4.8,
    ratingCount: 42,
    ...
    coverUri:
      "https://images.unsplash.com/photo-1562259949-e8e7689d7828?w=500&q=80",
    isVerified: true,
    destaque: false,
    plan: "free",
    onlineStatus: true,
  ...
  },
  {
    ...
    description:
      "Mercado completo no Jardim Recreio. Setor de hortifruti fresco todos os dias, açougue com carnes selecionadas, padaria própria e mercearia completa. Faça seu pedido e receba em casa.",
    rating: 4.6,
    ratingCount: 120,
  ...
  },
  {
    ...
    description:
      "A Farmácia São Lucas é a sua referência em saúde em Bragança Paulista. Grande estoque de medicamentos genéricos e de marca, setor de perfumaria, fraldas, higiene e atendimento 24h.",
    rating: 4.8,
    ratingCount: 85,
  ...
  },
  {
    ...
    description:
      "Amigo Animal oferece banho e tosa premium para cães e gatos, rações nacionais e importadas, farmácia veterinária, acessórios de passeio e brinquedos divertidos. Veterinário sob agendamento.",
    rating: 4.9,
    ratingCount: 45,
    // Coordenadas Jardim América
    latitude: -22.943,
...
async function main() {
  console.log(
    "Iniciando semeadura de prestadores e comércios em Bragança Paulista...",
  );

...
export const featuredAdsRouter = router({
  ...
  create: adminWriteProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      const maxOrder =
        all.length > 0 ? Math.max(...all.map((a) => a.displayOrder)) : -1;

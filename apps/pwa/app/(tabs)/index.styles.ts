...
export function createStyles(colors: ThemeColorPalette) {
  ...
  adminServiceName: { fontSize: 12, fontWeight: "700", color: colors.foreground },
  ...
  dropdownTriggerText: { fontSize: 14, color: colors.foreground, flex: 1 },
  dropdownList: {
    borderWidth: 1.5,
    borderColor: colors.border,
    borderRadius: 10,
  ...
  categoryTitleVertical: { fontSize: 16, fontWeight: "700", color: colors.foreground },
  categorySubtitleVertical: { fontSize: 12, color: colors.muted, marginTop: 2 },
  ...
  profCardCategory: { fontSize: 11, color: colors.muted, textAlign: "center" },

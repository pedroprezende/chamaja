...
export const subcategoriesByCategory: Record<string, Subcategory[]> = {
  ...
  "assistencia-tecnica": [
    ...
    {
      id: "tecnico-geladeira",
      name: "Técnico de Geladeira",
      categoryId: "assistencia-tecnica",
      icon: "kitchen",
      imageUrl:
  ...
  "servicos-externos": [
    ...
    },
    {
      ...
      icon: "pool",
      imageUrl:
        "https://images.unsplash.com/photo-1572331165267-854da2b021cf?w=400&q=80",
    },
    {
  ...
  "beleza-estetica": [
    ...
    },
    {
      ...
      icon: "draw",
      imageUrl:
        "https://images.unsplash.com/photo-1542856391383-a2f0432c2a6e?w=400&q=80",
    },
    {
      id: "esteticista",
      name: "Esteticista",
  ...
  "servicos-profissionais": [
    {
      id: "advogado",
      name: "Advogado",
      categoryId: "servicos-profissionais",
      icon: "gavel",
      imageUrl:
  ...
  saude: [
    {
      ...
      icon: "local-hospital",
      imageUrl:
        "https://images.unsplash.com/photo-1588776814546-1ffbb172d4f3?w=400&q=80",
    },
    {
      id: "fisioterapeuta",
      name: "Fisioterapeuta",
...
export const professionals: Professional[] = [
  ...
  },
  {
    ...
    paymentMethods: "Dinheiro, PIX",
    avatar:
      "https://images.unsplash.com/photo-1507876466519-514a6da1d4d0?w=200&q=80",
  },
  {
    id: "barbeiro-1",
  ...
  },
  {
    ...
    phone: "5511999990011",
    description:
      "Manutenção preventiva e corretiva para todos os tipos de veículos.",
  ...
  },
  {
    ...
    phone: "5511999990022",
    description:
      "Na Pizzaria Japa, tradição e criatividade se encontram em pizzas incríveis, feitas com ingredientes selecionados e muito amor! 🍕❤️",
    serviceArea: "Bragança Paulista",
    schedule: "Terça a Domingo: 18h às 23h",
    paymentMethods: "Dinheiro, Cartão, PIX",
    avatar:
      "https://images.unsplash.com/photo-1579758629938-03607ccdbaba?w=200&q=80",
    coverUri:
    ...
    services: JSON.stringify([
      ...
      },
      {
        ...
        name: "Portuguesa",
        description:
          "Molho de tomate, mussarela, presunto, ovos, cebola, pimentão e azeitonas.",
        price: 48.0,
        imageUri:
          "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=300&q=80",
        productCategory: "Pizzas Salgadas",
      ...
      },
      {
        ...
        price: 4.0,
        imageUri:
          "https://images.unsplash.com/photo-1608885898957-a599fb18de37?w=300&q=80",
        productCategory: "Bebidas",
        createdAt: new Date().toISOString(),
      },
    ]),
...
export function createProfessional(
  ...
  // Look up the subcategory ID by name to ensure it matches an existing subcategory
  const categoryName = registration.category.toLowerCase().replace(/\s+/g, "-");
  let subcategoryId = categoryName;
  for (const subs of Object.values(subcategoriesByCategory)) {
    const match = subs.find(
      (s) => s.name.toLowerCase().replace(/\s+/g, "-") === categoryName,
    );
    if (match) {
...
export const reviews: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Excelente profissional! Resolveu o problema rápido e com qualidade. Recomendo!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Muito profissional e educado. Fez um ótimo trabalho na instalação.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "As refeições são deliciosas! Minha família adora. Muito recomendado!",
